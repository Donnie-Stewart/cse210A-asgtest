// Dafny program Homework6.dfy compiled into C#
...
namespace _module {
  ...
  public abstract class Tree<T> {
    public Tree() { }
    public static Tree<T> Default() {
      return create_Leaf();
    }
    public static Dafny.TypeDescriptor<Tree<T>> _TypeDescriptor() {
      return new Dafny.TypeDescriptor<Tree<T>>(Tree<T>.Default());
    }
    public static Tree<T> create_Leaf() {
      return new Tree_Leaf<T>();
    }
    public static Tree<T> create_Node(Tree<T> _a0, Tree<T> _a1, T _a2) {
      return new Tree_Node<T>(_a0, _a1, _a2);
    }
    public bool is_Leaf { get { return this is Tree_Leaf<T>; } }
    public bool is_Node { get { return this is Tree_Node<T>; } }
  }
  ...
  public class Tree_Node<T> : Tree<T> {
    public readonly Tree<T> _a0;
    public readonly Tree<T> _a1;
    public readonly T _a2;
    public Tree_Node(Tree<T> _a0, Tree<T> _a1, T _a2) {
      this._a0 = _a0;
      this._a1 = _a1;
      this._a2 = _a2;
    }
    public override bool Equals(object other) {
      var oth = other as Tree_Node<T>;
  ...
  public abstract class List<T> {
    public List() { }
    public static List<T> Default() {
      return create_Nil();
    }
    public static Dafny.TypeDescriptor<List<T>> _TypeDescriptor() {
      return new Dafny.TypeDescriptor<List<T>>(List<T>.Default());
    }
    public static List<T> create_Nil() {
      return new List_Nil<T>();
    }
    public static List<T> create_Cons(T _a0, List<T> _a1) {
      return new List_Cons<T>(_a0, _a1);
    }
  ...
  public class List_Cons<T> : List<T> {
    ...
    public readonly List<T> _a1;
    public List_Cons(T _a0, List<T> _a1) {
      this._a0 = _a0;
      this._a1 = _a1;
    }
    public override bool Equals(object other) {
