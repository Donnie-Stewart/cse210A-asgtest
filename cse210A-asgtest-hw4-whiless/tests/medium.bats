...
# @test "medium-4" {
#   check 'a := 98 ; b := 76 ; while ¬ ( a = b ) do { if a < b then b := b - a else a := a - b }' '⇒ skip; b := 76; while ¬(a=b) do { if (a<b) then { b := (b-a) } else { a := (a-b) } }, {a → 98}
...
@test "medium-5" {
  check 'a := 369 ; b := 1107 ; while ¬ ( a = b ) do { if a < b then b := b - a else a := a - b }' '⇒ skip; b := 1107; while ¬(a=b) do { if (a<b) then { b := (b-a) } else { a := (a-b) } }, {a → 369}
